...
<body>
    ...
    <header>
        <div class="wrapper">
            <div class="header">
                <a href="http://localhost/PXP_ProxiesFlowACF/wordpress/home/" class="header-left">
                ...
                <div class="header-menu">
                    <nav>
                        <ul>
                            ...
                            <li><a href="<?php echo esc_url(home_url('/index.php/reviews')); ?>">reviews</a></li>
                            <li><a href="<?php echo esc_url(home_url('/index.php/blog')); ?>">blog</a></li>
        ...
        <div class="mobile-menu" id="mobileMenu">
            <nav>
                <ul>
                    ...
                    <li><a onclick="closeMobileMenu()" href="<?php echo esc_url(home_url('/index.php/reviews')); ?>">reviews</a></li>
                    <li><a onclick="closeMobileMenu()" href="<?php echo esc_url(home_url('/index.php/blog')); ?>">blog</a></li>
